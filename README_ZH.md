# GPT-Rewind
一个简单的 DeepSeek 年度总结工具

中文版 | [English](README.md)

<img src="assets/imgs/icon.svg" width="150" alt="GPTLens Logo" />

一个全面的 AI 对话历史分析工具，为您提供与 AI 模型交互模式的洞察和可视化。
...
- **多模型支持**：分析不同 AI 模型的对话
- **语言检测**：识别使用的自然语言和编程语言
- **行为洞察**：发现礼貌模式、表情符号使用和交互风格
- **导出功能**：将您的年度总结保存为图片

## 更新日志
- 2025/12/13 支持 Windows 平台 🎉 感谢 @zengly22 的错误报告
...
3. **探索您的洞察**：
   - 使用箭头键或屏幕按钮导航不同页面
   - 查看您的年度概览、AI 伙伴、时间模式和交互风格
   - 使用"保存年度记忆"按钮将您的总结导出为图片
...
如果您遇到任何问题：
1. 检查您的 JSON 文件是否符合预期格式
2. 确保所有依赖项已正确安装
3. 检查服务器日志中的错误消息
4. 在 GitHub 上创建问题，详细说明您的问题